    ...
    MobileCalendar.prototype = {
        ...
        bindEvent: function(type) {
            ...
            function dateCtrlInit() {
                var user_date = localStorage.getItem('user_birthday')//字符串类型
                //console.log(localStorage.getItem('user_birthday'))
                
                var date = new Date(parseInt(user_date));//初始显示日期
                var dateArr = {
                    yy: date.getFullYear(),
                    mm: date.getMonth(),
                    dd: date.getDate() - 1
            ...
            function finishMobileDate(e) {
                ...
                //console.log((date_yy % passY + _self.minY) + "-" + date_mm + "-" + date_dd)
                var settime = (date_yy % passY + _self.minY) + "/" + date_mm + "/" + date_dd
                var new_birthday = (new Date(settime)).getTime()
                localStorage.setItem('user_birthday',new_birthday)
                //console.log(localStorage.getItem('user_birthday'))
